						...
						parallax_createClass(ParallaxInstance, [
							...
							},
							{
								...
								value: function wrapElement() {
									...
									var customWrapper =
										...
										this.element.closest(this.settings.customWrapper); // check is current image is in a <picture> tag
							...
							},
							{
								...
								value: function unWrapElement() {
									...
									var customWrapper =
										this.settings.customWrapper &&
										this.element.closest(this.settings.customWrapper); //if there is a custom wrapper, we jusy need to remove the class and style
					...
					(function () {
						function SimpleParallax(elements, options) {
							...
							if (this.settings.customContainer) {
								...
								this.customContainer = helpers_convertToArray(
